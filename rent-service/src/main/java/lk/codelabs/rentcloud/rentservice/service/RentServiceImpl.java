...
HystrixCommand.Setter setter;
    ...
    private Customer getCustomer(int customerId) throws ExecutionException, InterruptedException {
        ...
        {
            return restTemplate.getForObject("http://localhost:9001/services/customers/"+customerId,Customer.class);
        },()->{
            return new Customer();
        });
...
//        return vehicleCommand.execute();
       ...
       return restTemplate.getForObject("http://localhost:9002/services/vehicles/"+vehicleId,Vehicle.class);
